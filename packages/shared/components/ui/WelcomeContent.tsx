  ...
  return (
    <>
      ...
      <main className="home-container">
        ...
        >
          {/* ✅ NEW: About-like overlay + glows */}
          <div className="hero-pro__overlay" />
          <div className="hero-pro__glow hero-pro__glow--left" />
          <div className="hero-pro__glow hero-pro__glow--right" />
          ...
          <div className="hero-grid-pro">
            ...
            <div className="hero-content-pro">
              ...
              <h1 className="hero-title-pro">
                ...
                <span className="gradient-text-pro">Automate Workflows.</span>
                <br />
                Collect Better Data.
              </h1>

              <p className="hero-subtitle-pro">
                Revolutionary form builder with <strong>AI-ready architecture</strong>, intuitive no-code drag & drop, and
              ...
              <div className="hero-cta-pro">
                ...
                <Link href="#features" className="btn-pro btn-secondary-pro">
                  See Features <span className="btn-arrow">→</span>
                </Link>
              </div>
        ...
        <section className="section-pro bg-light-pro">
          ...
          <div className="capabilities-grid-pro">
            <div className="capability-card-pro">
              ...
              <p>
                Create as many forms as you need with no artificial limits. From simple contact forms to complex multi-step
                applications.
              </p>
            </div>
            ...
            <div className="capability-card-pro">
              ...
              <p>Enterprise-grade reliability you can count on. Your forms stay live 24/7 with automatic failover and redundancy.</p>
            </div>
            ...
            <div className="capability-card-pro">
              ...
              <p>Blazing fast forms that don't slow your site down. Optimized for performance with CDN delivery worldwide.</p>
            </div>
            ...
            <div className="capability-card-pro">
              ...
              <p>SOC 2 compliant with end-to-end encryption, GDPR ready, and HIPAA-compatible architecture for sensitive data.</p>
            </div>
          </div>
        </section>
        ...
        <section className="section-pro bg-white-pro">
          ...
          <div className="why-grid-pro">
            <div className="why-card-pro">
              ...
              <p>
                Create beautiful, custom forms with zero coding—simply drag, drop, and publish. Professional results in minutes,
                not hours.
              </p>
            ...
            <div className="why-card-pro">
              ...
              <p>
                HIPAA, GDPR & SOC 2 compliance built-in from day one, so your data stays locked down without complex configuration.
              </p>
              <ul className="feature-list-pro">
            ...
            <div className="why-card-pro">
              ...
              <p>
                Connect to Stripe, PayPal, Salesforce, or any webhook-based system without writing code or paying extra fees.
              </p>
              <ul className="feature-list-pro">
            ...
            <div className="why-card-pro">
              ...
              <p>Track completion rates, identify drop-off points, and optimize your forms with actionable insights and real-time data.</p>
              <ul className="feature-list-pro">
            ...
            <div className="why-card-pro">
              ...
              <p>
                Never lose your work. Every change is versioned automatically, letting you test freely and roll back if needed.
              </p>
              <ul className="feature-list-pro">
            ...
            <div className="why-card-pro">
              ...
              <p>Work together seamlessly with role-based permissions, shared templates, and real-time collaboration features.</p>
              <ul className="feature-list-pro">
        ...
        <section className="final-cta-pro">
          <div className="final-cta-content-pro">
            ...
            <p>Join professionals and businesses who've already made the switch to SmartForms</p>
            ...
            <div className="final-cta-actions">
              ...
              <Link href="/pricing" className="btn-pro btn-secondary-pro btn-large-pro">
                View Pricing
              </Link>
            </div>
